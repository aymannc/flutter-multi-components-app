import 'package:classapp/gallery_page.dart';
...
void main() {
  runApp(MaterialApp(
      ...
      home: MyApp(),
      theme: ThemeData(
        canvasColor: Color(0xFF282B4E),
        primaryColor: Color(0xFF282B4E),
        accentColor: Color(0xFF363868),
      )));
}

class MyApp extends StatelessWidget {
  static final int primaryColor = 0xFF282B4E;
  static final int secondaryColor = 0xFF363868;
